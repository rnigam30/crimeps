			 ...
			 <div class="backdrop"></div> 
				<div class="vertical_bar">
					...
					<ul class="menu">
                        ...
                        <li><a href="final.php" class="active">
						...
						<div class="table-responsive">
							<table class="table">
								...
								if(isset($_POST['search'])){
									...
									$selectquery = "SELECT * FROM fir where CONCAT(case_name,criminal_name,crime_type) LIKE '%$value_filter%' AND case_status='REVIEWED' ";
								}else{
									$selectquery = "select * from fir where case_status='REVIEWED' or case_status='COMPLETED' ";
									$value_filter = "";
								}
								...
								<td><a href="updatef.php?id=<?php echo $res['case_id']; ?>">ADD CASE</a></td> 
								</tr> 										
								<?php
								}
								?>
